...
router.post(
  "/postreportincident",
  ReportIncidentController.createReportIncident
);
router.get("/getreportincident", ReportIncidentController.getReportIncident);
router.get(
  "/getincidentreport/:id",
  ReportIncidentController.getReportsIncidentByKaryakarthaId
);
...
router.post(
  "/getReportsByKaryakarthaId",
  ReportvoterController.getReportsByKaryakarthaId
);
router.delete(
  "/deletereportkaryakartha/:id",
  ReportvoterController.deleteReportById
);
...
router.delete(
  "/deletekaryakarta/:username",
  KaryakarthaLoginController.deleteUser
);
